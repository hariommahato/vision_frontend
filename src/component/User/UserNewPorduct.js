...
const UserNewProduct = () => {
  ...
  }, [dispatch, alert, error, navigate, success,categoryError]);
  ...
  const createProductSubmitHandler = (e) => {
    ...
    myForm.set("isHotDeal", isHotDeal);
...
{
  console.log(isHotDeal,isFeatured)
}
            <Button
              id="createProductBtn"
              type="submit"
